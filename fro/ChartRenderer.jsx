...
const ChartHeader = ({ title, chart, titleColor, onRenameClick }) => {
...
function HistogramChart({ chart, customization, onRenameClick }) {
  ...
  return (
    <div style={baseCardStyle}>
      <ChartHeader title={theme.title} chart={chart} titleColor={theme.titleColor} onRenameClick={onRenameClick} />
...
function BarChartViz({ chart, customization, onRenameClick }) {
  const { data } = chart;
  const theme = buildTheme(customization, chart.id, chart.title);
  if (!data || data.length === 0) return null;
...
function ColumnChartViz({ chart, customization, onRenameClick }) {
...
function StackedColumnChartViz({ chart, customization, onRenameClick }) {
...
function LineChartViz({ chart, customization, onRenameClick }) {
...
function AreaChartViz({ chart, customization, onRenameClick }) {
  const { data, x_key = 'x', y_key = 'value', x_label } = chart;
  const theme = buildTheme(customization, chart.id, chart.title);
  if (!data || data.length === 0) return null;
...
function ComboChartViz({ chart, customization, onRenameClick }) {
  const {
    data,
    x_key = 'category',
    bar_key = 'bar_value',
...
function RadarChartViz({ chart, customization, onRenameClick }) {
...
function TreemapChartViz({ chart, customization, onRenameClick }) {
...
function BubbleChartViz({ chart, customization, onRenameClick }) {
  const {
    data,
    x_key = 'x',
    y_key = 'y',
...
function PieChartViz({ chart, customization, onRenameClick }) {
...
function ScatterPlot({ chart, customization, onRenameClick }) {
...
function BoxPlotTable({ chart, customization, onRenameClick }) {
  const { data } = chart;
  const theme = buildTheme(customization, chart.id, chart.title);
  if (!data || data.length === 0) return null;
...
function CorrelationHeatmap({ chart, customization, onRenameClick }) {
...
function ChartRenderer({ chart, customization, onRenameClick }) {
  ...
  switch (normalizedChart.type) {
    case 'histogram':
      return <HistogramChart chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'bar':
      return <BarChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'column':
      return <ColumnChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'stacked_column':
      return <StackedColumnChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'line':
      return <LineChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'area':
      return <AreaChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'combo':
      return <ComboChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'pie':
      return <PieChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'radar':
      return <RadarChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'treemap':
      return <TreemapChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'bubble':
      return <BubbleChartViz chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'scatter':
      return <ScatterPlot chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'boxplot':
      return <BoxPlotTable chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    case 'heatmap':
      return <CorrelationHeatmap chart={normalizedChart} customization={customization} onRenameClick={onRenameClick} />;
    default:
      return (
